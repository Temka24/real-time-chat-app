					...
					<div className='bg-[#1a1729] w-[90%] h-[92%] mx-auto rounded-[20px] flex flex-row'>
						<div className='w-[300px]'>
							...
							<div className='flex flex-row items-center justify-center gap-[10px] mt-[20px] relative'>
								...
								<div className='absolute bottom-[-20px] text-white/25 text-[14px]'>{status}</div>
							</div>
						</div>
						<div className='bg-black w-full h-full rounded-[20px]'>
							{
								selectedUserId ? (
									<div className='w-full h-full flex flex-col items-center justify-center'>
										<ActiveChat username={selectedUsername} avatar={selectedUserAvatar} msgs={msgs} />
										<div className='bg-[#1B1A22] w-full h-[15%] flex flex-row items-center justify-center gap-[20px] pb-[10px] relative'>
											<div onClick={() => setShowEmojiPicker(!showEmojiPicker)} className='text-sky-500 cursor-pointer'><AddReactionIcon sx={{ fontSize: "30px" }} /></div>
											{showEmojiPicker &&
											...
											/>
											<span onClick={sendMessage} className='absolute bg-violet-400 py-[6px] px-[25px] cursor-pointer hover:bg-violet-500 rounded-[20px] right-[5%]'><SendIcon sx={{ fontSize: "30px" }} /></span>
										</div>
									</div>
								) : (
